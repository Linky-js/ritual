      ...
      <form @submit.prevent="onSubmit" v-if="!successForm" class="modal__form">
        <div class="box-input">
          <input
            ...
            required
          />
          <label :class="{ hidden: inputName.trim() !== '' }" for="name"
            >ФИО</label
          >
        </div>
        <div class="box-input">
          <input
            ...
            required
          />
          <label :class="{ hidden: inputEmail.trim() !== '' }" for="email"
            >Email</label
          >
        </div>
        <div class="box-input">
        ...
        <div class="box-input">
          <input
            ...
            required
          />
          <label :class="{ hidden: inputCity.trim() !== '' }" for="city"
            >Город</label
          >
        </div>
        <div class="box-input">
          <input
            ...
            required
          />
          <label :class="{ hidden: inputWork.trim() !== '' }" for="work"
            >Род деятельности</label
          >
        </div>
        <div class="box-image">
          <input
        ...
        <div class="box-input">
          ...
          />
          <label
            :class="{ hidden: inputOrganization.trim() !== '' }"
            for="organization"
        ...
        <div class="box-input">
          <input
            ...
            ref="inputRef"
          />
          <label :class="{ hidden: inputLevel.trim() !== '' }" for="level"
            >Уровень вступления</label
          >
        </div>
        <div class="box-input box-input__textarea">
          <textarea v-model="inputDop" name="dop" id="dop" cols="30"></textarea>
          <label :class="{ hidden: inputDop.trim() !== '' }" for="dop"
            >Дополнительная информация о себе</label
          >
        </div>
        <div class="check">
